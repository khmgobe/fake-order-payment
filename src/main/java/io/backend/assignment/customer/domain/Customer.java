...
public class Customer {
    ...
    @Builder
    private Customer(
            final String name, final LocalDateTime createdAt, final LocalDateTime updatedAt) {
        this.name = name;
    ...
    private void validateConstructor(
            final String name, final LocalDateTime create_at, final LocalDateTime update_at) {
